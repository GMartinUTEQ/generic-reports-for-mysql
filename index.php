  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        ...
        <img style="max-width:300px" src="./ProjImg/Logo.png" />
      </div>
      <div class="card-body">
        <p class="login-box-msg">Iniciar Sesión</p>

        <form action="./val_u.php" method="post">
          <div class="input-group mb-3">
            <select required class="form-control" id="idsistema" name="idsistema">
              <option value="0">Seleccione un sistema</option>
              <?php
              include_once("./C0n3cZi.on.php");

              $sql = "select * from sistema where activo = 1";
          ...
          <div class="input-group mb-3">
            <input required type="password" name="usuario" id="usuario" class="form-control" placeholder="Usuario">
            <div class="input-group-append">
              <div class="input-group-text">
